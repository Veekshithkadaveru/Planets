...
fun getPlanets(): List<PlanetInfo> {
    return listOf(
        PlanetInfo(
            1,
            name = "Mercury",
            iconImage = R.drawable.mercury,
            description = stringResource(id = R.string.mercury_description),
            listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.venus_description),
            images = listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.earth_description),
            images = listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.mars_description),
            images = listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.jupiter_description),
            images = listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.saturn_description),
            images = listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.uranus_description),
            images = listOf(
        ...
        PlanetInfo(
            ...
            description = stringResource(id = R.string.neptune_description),
            images = listOf(
